...
const CampSite = ({ backgroundImage, title, subtitle, peopleJoined }: CampProps) => {
  return(
    ...
    lg:rounded-r-5xl 2xl:rounded-r-5xl`}>
      ...
      lg:py-10"> 
        ...
        <div className="flexCenter gap-6">
          ...
          <p className="bold-16 sm:bold-20 text-white">{peopleJoined}</p>
        </div>
      </div>
    </div>
  )
  ...
  return (
    ...
    lg:mb-10 lg:py-20 xl:mb-20'>
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 p-8 lg:max-w-[734px] xl:rounded-5xl 
        xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
          <h2 className="regular-24 md:regular-32 2xl:regular-64 capitalize text-white">
            <strong>Feeling Lost</strong> And Not Knowing The Way?
          </h2>
          <p className="regular-14 xl:regular-16 mt-5 text-white">
          Starting from the anxiety of climbers when visiting a new 
